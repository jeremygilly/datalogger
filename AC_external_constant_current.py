...
# set up
def AC_initialisation(adc):
    adc.mode1(CHOP = '2-wire ac-excitation', CONVRT = 'continuous', DELAY = '50us')
    adc.mode2(gpio3_connection = 'disconnect', gpio2_connection = 'disconnect', gpio1_connection = 'disconnect', gpio0_connection = 'connect',
              gpio3_direction = 'output', gpio2_direction = 'output', gpio1_direction = 'output', gpio0_direction = 'output')
    adc.reference_config(reference_enable=1, RMUXP = 'AIN0', RMUXN = 'AIN1')
    

def check_AC_initialisation(adc, pin):
    chop, conversion, delay = adc.check_mode1()
    gpio3_connection, gpio2_connection, gpio1_connection, gpio0_connection, gpio3_direction, gpio2_direction, gpio1_direction, gpio0_direction = adc.check_mode2()
...
def main():
    ...
    measurement_pairs = [
        ['AIN4', 'AIN5'],   # sense pad 1
        ['AIN5', 'AIN6'],   # between sense pads 1 & 2
